...
{
    Vector p( 1.0f*x/(float)m_WindowWidth*2.0f - 1.0f, 1.0f*y/(float)m_WindowHeight*2.0f -1.0f, 0);
    p.Y = -p.Y;
...
void Camera::setWindowWidthHeight(unsigned int p_Width, unsigned int p_Height) {
